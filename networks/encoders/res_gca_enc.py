...
class ResGuidedCxtAtten(ResNet_D):
    """Resnet encoder with guided contextual attention."""
    ...
    def forward(self, x):
        ...
        Returns:
            out: Output tensor.
            dict: Dictionary with intermediate feature maps."""
        ...
        unknown = F.interpolate(x[:, 4:5, ...], scale_factor=1/8, mode='nearest', recompute_scale_factor=True)
